...
public class StarRating extends JFrame {
	...
	public StarRating() {
		...
		JScrollPane scrollPane = new JScrollPane(new StarRatingPanel());
	...
	class StarRatingPanel extends JPanel{
		private JLabel Star = new JLabel("별점순");
...
private JLabel informationLabel[] = {new JLabel("<HTML><body style='font-size:1.7em;font-family:휴먼편지체;'>★ 4. 96<br>휴무일 : 일, 월<br>☎ 0507-1446-4562<br>도보 16분</body></HTML>"),
		...
		public StarRatingPanel() {
			...
			Star.setSize(120,40);
			Star.setLocation(60,15);
			Star.setForeground(Color.BLACK);
			Star.setFont(new Font("휴먼편지체",Font.BOLD,30));
			add(Star);
